...
feature 'Visitant view subisidiaries' do
  scenario 'see index of subsidiaries' do
    subsidiary_a = Subsidiary.new(id: 1, name: 'Vila Maria', address: 'Avenida Osvaldo Reis, 801', cep: '88306-773')
    subsidiary_b = Subsidiary.new(id: 2, name: 'Ipiranga', address: 'Rua da Concórdia, 201', cep: '57071-812')
    subsidiary_c = Subsidiary.new(id: 3, name: 'Santos', address: 'Rua das Hortências, 302', cep: '78150-384')
